...
// trailer is the discriminator: the converter appends it to files it actually reshaped, and the
// client DLL reads it at load to scope the modern pipelines to tagged instances only. An untagged
// file takes the stock path end to end. The layout mirrors wxl-modern-assets' shared/common/WxlTag.hpp
...
namespace wxl::converter::common::tag
{
